...
<skill>
<name>journal-catalog</name>
<description>
Maintain the canonical journals.yml used across the literature pipeline. 
Includes: enriching OpenAlex source IDs via ISSN/EISSN, validating metadata, 
and exporting versioned Markdown tables of the journal set. 
...
<skill>
<name>journal-search</name>
<description>
Search OpenAlex works using the configured journal catalog. 
